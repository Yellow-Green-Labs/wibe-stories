...
const UI = {
  en: {
    ...
    backToBlog: 'Back to blog', related: 'Related stories', prevArticle: 'Previous story', nextArticle: 'Next story', onThisPage: 'Contents',
    ...
    signature: '— Spoken, not typed. Thanks <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'Questions?', supportContact: 'Contact us', contactUs: 'Contact us',
    independence: 'Independent project · Not affiliated with Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Browse all stories', browseShort: 'Browse',
    ...
    close: 'Close',
    seeAll: 'See all results', resultsFor: 'stories for', resultsForOne: 'story for',
    searchPrompt: 'Type a few words to search across all stories.', searchPageTitle: 'Search', searching: 'Searching…', searchHints: 'Use ↑↓ to move, Enter to open, Esc to close.',
    skipToContent: 'Skip to content', followX: 'Follow on X', followLinkedIn: 'Follow on LinkedIn',
  },
  th: {
    ...
    backToBlog: 'กลับไปที่บล็อก', related: 'เรื่องราวที่เกี่ยวข้อง', prevArticle: 'เรื่องก่อนหน้า', nextArticle: 'เรื่องถัดไป', onThisPage: 'ในหน้านี้',
    ...
    signature: '— พูด ไม่ได้พิมพ์ ขอบคุณ <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'มีคำถาม?', supportContact: 'ติดต่อเรา', contactUs: 'ติดต่อเรา',
    independence: 'โปรเจกต์อิสระ · ไม่เกี่ยวข้องกับ Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'ดูเรื่องราวทั้งหมด', browseShort: 'เรียกดู',
    ...
    close: 'ปิด',
    seeAll: 'ดูผลลัพธ์ทั้งหมด', resultsFor: 'เรื่อง สำหรับ', resultsForOne: 'เรื่อง สำหรับ',
    searchPrompt: 'พิมพ์คำค้นเพื่อค้นหาเรื่องทั้งหมด', searchPageTitle: 'ค้นหา', searching: 'กำลังค้นหา…', searchHints: 'ใช้ ↑↓ เพื่อเลื่อน, Enter เพื่อเปิด, Esc เพื่อปิด',
    skipToContent: 'ข้ามไปที่เนื้อหา', followX: 'ติดตามบน X', followLinkedIn: 'ติดตามบน LinkedIn',
  },
  ko: {
    ...
    backToBlog: '블로그로 돌아가기', related: '관련 이야기', prevArticle: '이전 이야기', nextArticle: '다음 이야기', onThisPage: '이 페이지에서',
    ...
    signature: '— 타자가 아닌, 말로 전하는 마음. <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a> 감사합니다!',
    ...
    supportQuestion: '질문이 있나요?', supportContact: '문의하기', contactUs: '문의하기',
    independence: '독립 프로젝트 · Wispr Flow와 무관합니다',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: '모든 이야기 보기', browseShort: '보기',
    ...
    close: '닫기',
    seeAll: '모든 결과 보기', resultsFor: '개의 이야기', resultsForOne: '개의 이야기',
    searchPrompt: '모든 이야기를 검색하려면 몇 단어를 입력하세요.', searchPageTitle: '검색', searching: '검색 중…', searchHints: '↑↓ 이동, Enter 열기, Esc 닫기',
    skipToContent: '본문으로 건너뛰기', followX: 'X에서 팔로우', followLinkedIn: 'LinkedIn에서 팔로우',
  },
  ja: {
    ...
    backToBlog: 'ブログに戻る', related: '関連記事', prevArticle: '前の記事', nextArticle: '次の記事', onThisPage: 'このページ内',
    ...
    signature: '— タイピングではなく、話すこと。<a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a> に感謝！',
    ...
    supportQuestion: '質問がありますか？', supportContact: 'お問い合わせ', contactUs: 'お問い合わせ',
    independence: '独立プロジェクト · Wispr Flow とは関係ありません',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'すべての記事を見る', browseShort: '見る',
    ...
    close: '閉じる',
    seeAll: 'すべての結果を見る', resultsFor: '件の記事', resultsForOne: '件の記事',
    searchPrompt: 'すべての記事を検索するには、いくつか言葉を入力してください。', searchPageTitle: '検索', searching: '検索中…', searchHints: '↑↓ で移動、Enter で開く、Esc で閉じる',
    skipToContent: '本文へスキップ', followX: 'Xでフォロー', followLinkedIn: 'LinkedInでフォロー',
  },
  es: {
    ...
    backToBlog: 'Volver al blog', related: 'Historias relacionadas', prevArticle: 'Historia anterior', nextArticle: 'Siguiente historia', onThisPage: 'En esta página',
    ...
    signature: '— Hablado, no escrito. ¡Gracias <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: '¿Preguntas?', supportContact: 'Contáctanos', contactUs: 'Contáctanos',
    independence: 'Proyecto independiente · No afiliado a Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Ver todas las historias', browseShort: 'Ver',
    ...
    close: 'Cerrar',
    seeAll: 'Ver todos los resultados', resultsFor: 'historias para', resultsForOne: 'historia para',
    searchPrompt: 'Escribe algunas palabras para buscar en todas las historias.', searchPageTitle: 'Buscar', searching: 'Buscando…', searchHints: 'Usa ↑↓ para moverte, Enter para abrir, Esc para cerrar.',
    skipToContent: 'Saltar al contenido', followX: 'Seguir en X', followLinkedIn: 'Seguir en LinkedIn',
  },
  it: {
    ...
    backToBlog: 'Torna al blog', related: 'Storie correlate', prevArticle: 'Storia precedente', nextArticle: 'Storia successiva', onThisPage: 'In questa pagina',
    ...
    signature: '— Parlato, non scritto. Grazie <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'Domande?', supportContact: 'Contattaci', contactUs: 'Contattaci',
    independence: 'Progetto indipendente · Non affiliato a Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Vedi tutte le storie', browseShort: 'Vedi',
    ...
    close: 'Chiudi',
    seeAll: 'Vedi tutti i risultati', resultsFor: 'storie per', resultsForOne: 'storia per',
    searchPrompt: 'Scrivi qualche parola per cercare tra tutte le storie.', searchPageTitle: 'Cerca', searching: 'Ricerca in corso…', searchHints: 'Usa ↑↓ per spostarti, Invio per aprire, Esc per chiudere.',
    skipToContent: 'Vai al contenuto', followX: 'Segui su X', followLinkedIn: 'Segui su LinkedIn',
  },
  tl: {
    ...
    backToBlog: 'Bumalik sa blog', related: 'Mga kaugnay na kwento', prevArticle: 'Nakaraang kwento', nextArticle: 'Susunod na kwento', onThisPage: 'Sa pahinang ito',
    ...
    signature: '— Sinabi, hindi nai-type. Salamat, <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'May tanong?', supportContact: 'Makipag-ugnayan', contactUs: 'Makipag-ugnayan',
    independence: 'Independenteng proyekto · Hindi kaakibat ng Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Tingnan ang lahat ng kwento', browseShort: 'Tingnan',
    ...
    close: 'Isara',
    seeAll: 'Tingnan lahat ng resulta', resultsFor: 'kuwento para sa', resultsForOne: 'kuwento para sa',
    searchPrompt: 'Mag-type ng ilang salita upang maghanap sa lahat ng kuwento.', searchPageTitle: 'Maghanap', searching: 'Naghahanap…', searchHints: 'Gamitin ang ↑↓ para gumalaw, Enter para buksan, Esc para isara.',
    skipToContent: 'Laktawan sa nilalaman', followX: 'I-follow sa X', followLinkedIn: 'I-follow sa LinkedIn',
  },
  tr: {
    ...
    backToBlog: 'Bloga dön', related: 'İlgili hikayeler', prevArticle: 'Önceki hikaye', nextArticle: 'Sonraki hikaye', onThisPage: 'Bu sayfada',
    ...
    signature: '— Yazılmadı, söylendi. Teşekkürler <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'Soruların mı var?', supportContact: 'Bize ulaşın', contactUs: 'Bize ulaşın',
    independence: 'Bağımsız proje · Wispr Flow ile bağlantılı değildir',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Tüm hikayeleri gör', browseShort: 'Gör',
    ...
    close: 'Kapat',
    seeAll: 'Tüm sonuçları gör', resultsFor: 'hikaye için', resultsForOne: 'hikaye için',
    searchPrompt: 'Tüm hikayelerde arama yapmak için birkaç kelime yazın.', searchPageTitle: 'Ara', searching: 'Aranıyor…', searchHints: 'Gezmek için ↑↓, açmak için Enter, kapatmak için Esc.',
    skipToContent: 'İçeriğe geç', followX: 'X\'te takip et', followLinkedIn: 'LinkedIn\'de takip et',
  },
  sv: {
    ...
    backToBlog: 'Tillbaka till bloggen', related: 'Relaterade berättelser', prevArticle: 'Föregående berättelse', nextArticle: 'Nästa berättelse', onThisPage: 'På denna sida',
    ...
    signature: '— Talat, inte skrivet. Tack <a href="https://wisprflow.ai" target="_blank" rel="noopener">Wispr</a>!',
    ...
    supportQuestion: 'Frågor?', supportContact: 'Kontakta oss', contactUs: 'Kontakta oss',
    independence: 'Självständigt projekt · Inte anslutet till Wispr Flow',
    publication: 'A Wibe Stories Publication', copyright: '© 2026 YG Labs', browseAll: 'Visa alla berättelser', browseShort: 'Visa',
    ...
    close: 'Stäng',
    seeAll: 'Visa alla resultat', resultsFor: 'berättelser för', resultsForOne: 'berättelse för',
    searchPrompt: 'Skriv några ord för att söka i alla berättelser.', searchPageTitle: 'Sök', searching: 'Söker…', searchHints: 'Använd ↑↓ för att flytta, Enter för att öppna, Esc för att stänga.',
    skipToContent: 'Hoppa till innehåll', followX: 'Följ på X', followLinkedIn: 'Följ på LinkedIn',
  },
}
