(function () {
  ...
  var SAMPLE_CARDS = [
    { id: "s1", shortId: "demo-a1", name: "Happy Birthday to Mom", text: "Happy Birthday Mom! Love you!", authorName: "Sarah", tone: "warm", occasion: "birthday", hasAudio: false, createdAt: "2026-07-10T10:30:00Z", theme: "birthday" },
    { id: "s2", shortId: "demo-b2", name: "Diwali Wishes", text: "Wishing you a festival of lights filled with joy!", authorName: "Raj", tone: "poetic", occasion: "diwali", hasAudio: true, createdAt: "2026-07-08T14:00:00Z", theme: "diwali" },
    { id: "s3", shortId: "demo-c3", name: "Happy Anniversary", text: "To many more years of love and happiness.", authorName: "Priya", tone: "warm", occasion: "anniversary", hasAudio: false, createdAt: "2026-07-05T09:00:00Z", theme: "anniversary" },
    { id: "s4", shortId: "demo-d4", name: "Get Well Soon", text: "Sending you warm wishes for a speedy recovery!", authorName: "Mike", tone: "warm", occasion: "get-well", hasAudio: true, createdAt: "2026-07-03T16:45:00Z", theme: "get-well" },
    { id: "s5", shortId: "demo-e5", name: "Just Thinking of You", text: "Hey, just wanted to say I miss you. Hope you're doing great!", authorName: "Emma", tone: "honest", occasion: "", hasAudio: false, createdAt: "2026-06-28T20:15:00Z", theme: "just-because" },
    { id: "s6", shortId: "demo-f6", name: "Congratulations!", text: "You did it! So proud of everything you've achieved.", authorName: "Alex", tone: "bold", occasion: "congratulations", hasAudio: true, createdAt: "2026-06-20T11:00:00Z", theme: "congratulations" },
    { id: "s7", shortId: "demo-g7", name: "Happy Eid", text: "Eid Mubarak! Wishing you peace and blessings.", authorName: "Fatima", tone: "warm", occasion: "eid", hasAudio: false, createdAt: "2026-06-15T08:30:00Z", theme: "eid" },
    { id: "s8", shortId: "demo-h8", name: "Thank You", text: "Thank you for everything you do. You're the best!", authorName: "David", tone: "reflective", occasion: "thank-you", hasAudio: false, createdAt: "2026-06-10T13:00:00Z", theme: "thank-you" }
  ];
  ...
  function buildVault() {
    ...
    overlay.innerHTML =
      '<div class="vault-header">' +
        ...
        '</button>' +
        '<span class="vault-title">My World</span>' +
      ...
      '<div class="vault-content" id="vault-content">' +
        ...
        '<div class="vault-locked" id="vault-locked">' +
          ...
          '<div class="vault-locked-title">My World is a Pro feature</div>' +
      ...
      '<div class="vault-action-bar" id="vault-action-bar">' +
        ...
        '<div class="vault-action-btns">' +
          '<button class="vault-action-btn vault-action-btn-download" id="vault-dl-btn">\u2B07 Download</button>' +
          '<button class="vault-action-btn vault-action-btn-delete" id="vault-del-btn">\u{1F5D1} Delete</button>' +
        '</div>' +
      '</div>' +
  ...
  function render() {
    ...
    var loading = document.getElementById("vault-loading");
    ...
    for (var i = 0; i < allCards.length; i++) {
      ...
      html +=
        '<div class="vault-tile" data-id="' + c.id + '">' +
          '<div class="vault-tile-check' + checked + '"></div>' +
          '<div class="vault-tile-thumb">' +
            '<span>' + emoji + '</span>' +
            (c.hasAudio ? '<span class="vault-tile-audio-badge"><i class="fa-solid fa-volume-high"></i></span>' : '') +
          '</div>' +
  ...
  function toggleSelectMode() {
    ...
    document.getElementById("vault-action-bar").classList.toggle("visible", selectMode && Object.keys(selectedIds).length > 0);
    updateSelectBtnLabel();
    updateActionBar();
    render();
  }
  ...
  function updateActionBar() {
    ...
    document.getElementById("vault-action-count").textContent = count + " selected";
    document.getElementById("vault-del-btn").disabled = count === 0;
    document.getElementById("vault-dl-btn").disabled = count === 0;
  ...
  function downloadSelected() {
    /* Phase 1: placeholder — real download needs card images */
    var count = Object.keys(selectedIds).length;
    var msg = "Download " + count + " card" + (count > 1 ? "s" : "") + "?";
    msg += " (Image download will work once cards are created with the app)";
    alert(msg);
  }
  ...
  function shareCardView() {
    if (cardViewCard) {
      ...
      alert("Card link copied: " + url);
    }
  }

  function downloadCardView() {
    if (cardViewCard) {
      alert("Download: " + cardViewCard.shortId + " (image download coming when cards are created with the app)");
    }
  }
  ...
  function updateMenuLabel(retries) {
    ...
    label.textContent = isPro() ? "My World" : "\u{1F512} My World";
  }
