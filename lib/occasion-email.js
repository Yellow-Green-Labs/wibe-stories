...
export const OCCASIONS = [
  ...
  { id: 'mother-language-day', month: 2, day: 21,   name: 'International Mother Language Day', dateLabel: 'February 21', greeting: 'Speak the words of home.',                                   img: IMG_BASE + 'international-mother-language-day.png' },
  ...
  { id: 'world-voice-day',    month: 4,  day: 16,   name: 'World Voice Day',               dateLabel: 'April 16',          greeting: 'Make yourself heard.',                                       img: IMG_BASE + 'world-voice-day.png' },
...
${quoteHtml}
          ...
          <tr>
            <td align="center" style="background-color:#111111;padding:28px 24px 24px;">
              ...
              <p style="font-family:'DM Sans',Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;color:#8b8b76;margin:0 0 4px;">We&rsquo;d love to hear from you:</p>
              <p style="font-family:'DM Sans',Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;margin:0;">
                <a href="https://tally.so/r/obaD1M" style="color:#8b8b76;text-decoration:underline;">Contact us</a>
                <span style="color:#555548;">&nbsp;&middot;&nbsp;</span>
                <a href="https://tally.so/r/jaqlJ6" style="color:#8b8b76;text-decoration:underline;">Help us improve</a>
              </p>
              <div style="height:12px;line-height:12px;font-size:1px;">&nbsp;</div>
              <p style="font-family:'DM Sans',Arial,Helvetica,sans-serif;font-size:11px;line-height:1.6;margin:0;">
